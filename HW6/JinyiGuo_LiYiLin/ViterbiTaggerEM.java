...
//                            }
            ...
            tokenCount -= 1.0; // training data token
...
//            orgCount = new HashMap<String, Double>();
    ...
    public void emTag(List<String> words, List<String> testTags, int iters) {
        ...
        for(int epoc = 0; epoc < iters; epoc++) {
            ...
            token = tokenCount + rawWords.size() - 1;
            v = vocabulary;
